...
class GoogleSearchConsoleBaseTest(unittest.TestCase):
    ...
    DATETIME_FMT = {"%Y-%m-%dT%H:%M:%SZ", "%Y-%m-%dT%H:%M:%S.000000Z"}
    ...
    def get_properties(self, original: bool = True):
        ...
        properties_dict = {
            ...
            else dt.strftime(self.start_date, self.START_DATE_FORMAT),
        }
    ...
    def expected_automatic_fields(self):
        """return a dictionary with key of table name and set of value of
        automatic(primary key and bookmark field) fields."""
        auto_fields = {}
